(function ($) {
  ...
  if ($(".mobile-nav__container .main-menu__list").length) {
    ...
    // Add click handler for all li elements in the menu
    $(".mobile-nav__container .main-menu__list li").on('click', function (e) {
      // Don't close if clicking on dropdown toggle button or its children
      if (!$(e.target).is('button') && !$(e.target).closest('button').length) {
        // Close the mobile nav
        $(".mobile-nav__wrapper").removeClass("expanded");
        $("body").removeClass("locked");

        // If this is a dropdown link, follow the link
        if ($(this).hasClass('dropdown') && !$(e.target).is('a')) {
